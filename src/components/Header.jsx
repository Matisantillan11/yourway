        ...
        <>
            <header>
                ...
                <ul className="menu_item" status={state} onClick={handleMenu}>
                    ...
                    <li className="menu_item_link"><a className="link-menu" href="" />Nosotros</li>
                    <li className="menu_item_link"><a className="link-menu" href="" />Contactanos</li>
                </ul>
                <div className="menu_cart-container">
                    <i className="fas fa-shopping-cart" onClick={handleOpenCart} />
                    <p>{totalQuantity}</p>
                </div>
